...
@section('content')
    ...
    <div class="content-wrapper">
      ...
      <!-- form start -->
    <body>
        <form action="{{ route('rak.update', $rak[0]->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="card-body">
                <div class="form-group">
                    <label for="nama">Nama Rak</label>
                    <input class="form-control" type="text" name="nama" id="nama" placeholder="Masukan nama rak" value="{{ $rak[0]->nama }}">
                </div>
                <div class="form-group">
                    <label for="lokasi">Lokasi Rak</label>
                    <input class="form-control" type="text" name="lokasi" id="lokasi" placeholder="Masukan lokasi" value="{{ $rak[0]->lokasi }}">
                </div>
                <td>
