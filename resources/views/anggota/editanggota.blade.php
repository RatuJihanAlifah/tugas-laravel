                            ...
                            <form action="{{ route('anggota.update', $anggota[0]->id) }}" method="POST">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        placeholder="Masukkan ID" value="{{ $anggota[0]->id}}">
                                    </div>
                                    @error('id')
                                    ...
                                    <div class="form-group">
                                        ...
                                        placeholder="Masukan kode" name="kode_anggota" value="{{ $anggota[0]->kode_anggota}}">
                                    </div>
                                    @error('kode-anggota')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                    <div class="form-group">
                                        ...
                                        placeholder="Masukan nama" name="nama" value="{{ $anggota[0]->nama}}">
                                    </div>
                                    @error('nama')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control"
                                                data-inputmask='"mask": "(999) 999-9999"' data-mask placeholder="Masukan angka" name="no_telepon" value="{{ $anggota[0]->no_telepon}}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                            <label>Alamat</label>
                                            <textarea class="form-control" rows="3" placeholder="Masukan alamat" name="alamat">{{ $anggota[0]->alamat}}</textarea>
                                        </div>
                                </div>
                                    <td>
